...
open class ComponentizedBuilder<Component, Router, DynamicBuildDependency, DynamicComponentDependency>: Buildable {
  ...
  public final func build(
    ...
    let component = self.componentBuilder(dynamicComponentDependency)
    ...
    return (component, self.build(with: component, dynamicBuildDependency))
  }
...
open class SimpleComponentizedBuilder<Component, Router>: ComponentizedBuilder<Component, Router, (), ()> {
  ...
  override public final func build(with component: Component, _ dynamicDependency: ()) -> Router {
    return self.build(with: component)
  }
  ...
  public final func build() -> Router {
    return self.build(withDynamicBuildDependency: (), dynamicComponentDependency: ())
  }
}
